...
style_img = image_loader("vangogh_starry_night.jpg").type(dtype)
content_img = image_loader("howard_party.jpg").type(dtype)


#a=content_img[0,1,0:512,::]
style_img=torch.cat((style_img[0,0,0:512,0:512].unsqueeze(0),
                      style_img[0,1,0:512,0:512].unsqueeze(0),
                      style_img[0,2,0:512,0:512].unsqueeze(0))).unsqueeze(0)

content_img=torch.cat((content_img[0,0,0:512,::].unsqueeze(0),
                      content_img[0,1,0:512,::].unsqueeze(0),
                      content_img[0,2,0:512,::].unsqueeze(0))).unsqueeze(0)
...
torch.save(cnn.state_dict(), 'cnn_von.pkl')

plt.figure()
imshow(output, title='Output Image')
imshow(content_img.data, title='Output Image')
